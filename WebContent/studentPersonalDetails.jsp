			...
			<form action="studentEducationDetails.jsp" method="post">
				<table>
					<tr>
					     <p id="nameMessage"></p>
						<td>Student Name:</td>
						<td><input type="text" name="name" id="name" required onchange="validateName()" ></td>
					</tr>
					<tr>
						<td>Email:</td>
					...
					<tr>
						<td>Father Name:</td>
						<td><input type="text" name="fatherName" id="fatherName" required  onchange="validateFatherName()"></td>
					</tr>
					<tr>
						<td>Mother Name:</td>
						<td><input type="text" name="motherName" id="motherName" required  onchange="validateMotherName()"></td>
					</tr>
