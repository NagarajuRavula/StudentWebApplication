...
<body onload="temp()">
	...
	<%
		StudentManagementService studentManagementServic = (StudentManagementService) ObjectFactory
				...
				<fieldset id="formFields" disabled>
					...
					<fieldset>
						<input type="text" tabindex="4" id="motherName" name="motherName"
							value='<%=std.getMothername()%>' data-tooltip
